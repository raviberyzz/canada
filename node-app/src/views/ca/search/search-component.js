(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["CoveoSunlifeCa"] = factory(require("coveo-search-ui"), require("underscore"));
	else
		root["CoveoSunlifeCa"] = factory(root["Coveo"], root["_"]);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.SunlifeSearch = void 0;
var coveo_search_ui_1 = __webpack_require__(0);
var turbo_core_1 = __webpack_require__(1);
var SunlifeSearch = /** @class */ (function (_super) {
    __extends(SunlifeSearch, _super);
    function SunlifeSearch(element, options, bindings) {
        var _this = _super.call(this, element, SunlifeSearch_1.ID, bindings) || this;
    ...
    return SunlifeSearch;
}(coveo_search_ui_1.Component));
exports.SunlifeSearch = SunlifeSearch;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ShowIfFieldValue = void 0;
var coveo_search_ui_1 = __webpack_require__(0);
var turbo_core_1 = __webpack_require__(1);
var ShowIfFieldValue = /** @class */ (function (_super) {
    __extends(ShowIfFieldValue, _super);
    function ShowIfFieldValue(element, options, bindings, result) {
        var _this = _super.call(this, element, ShowIfFieldValue_1.ID, bindings) || this;
        _this.element = element;
        _this.options = options;
        _this.bindings = bindings;
        _this.result = result;
        _this.options = coveo_search_ui_1.ComponentOptions.initComponentOptions(element, ShowIfFieldValue_1, options);
        _this.render();
        return _this;
    }
    ShowIfFieldValue_1 = ShowIfFieldValue;
    ShowIfFieldValue.prototype.render = function () {
        var field = this.options.field;
        //IFieldOpton is always prefixed with @; remove it
        field = field.substr(1);
        var resultValue = this.result.raw[field];
        if (resultValue !== this.options.fieldValue) {
            Coveo.$$(this.element).hide();
        }
    };
    var ShowIfFieldValue_1;
    ShowIfFieldValue.ID = 'ShowIfFieldValue';
    ShowIfFieldValue.options = {
        field: coveo_search_ui_1.ComponentOptions.buildFieldOption({ required: true }),
        fieldValue: coveo_search_ui_1.ComponentOptions.buildStringOption()
    };
    ShowIfFieldValue = ShowIfFieldValue_1 = __decorate([
        turbo_core_1.lazyComponent
    ], ShowIfFieldValue);
    return ShowIfFieldValue;
}(coveo_search_ui_1.Component));
exports.ShowIfFieldValue = ShowIfFieldValue;
