...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["CoveoSunlifePoc"] = factory(require("coveo-search-ui"), require("underscore"));
	else
		root["CoveoSunlifePoc"] = factory(root["Coveo"], root["_"]);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.SunlifePoc = void 0;
var coveo_search_ui_1 = __webpack_require__(0);
var turbo_core_1 = __webpack_require__(1);
var SunlifePoc = /** @class */ (function (_super) {
    __extends(SunlifePoc, _super);
    function SunlifePoc(element, options, bindings) {
        var _this = _super.call(this, element, SunlifePoc_1.ID, bindings) || this;
        _this.element = element;
        _this.options = options;
        _this.bindings = bindings;
        _this.options = coveo_search_ui_1.ComponentOptions.initComponentOptions(element, SunlifePoc_1, options);
        return _this;
    }
    SunlifePoc_1 = SunlifePoc;
    var SunlifePoc_1;
    SunlifePoc.ID = 'SunlifePoc';
    SunlifePoc.options = {};
    SunlifePoc = SunlifePoc_1 = __decorate([
        turbo_core_1.lazyComponent
    ], SunlifePoc);
    return SunlifePoc;
}(coveo_search_ui_1.Component));
exports.SunlifePoc = SunlifePoc;
...
var turbo_core_1 = __webpack_require__(5);
var CountedTabs = /** @class */ (function (_super) {
    ...
    CountedTabs.prototype.buildGroupByRequest = function (field) {
        return {
            'field': field,
